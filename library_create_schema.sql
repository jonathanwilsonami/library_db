...
CREATE TABLE IF NOT EXISTS Material (
    ...
    title VARCHAR(500), -- The title of the material.
    publication_date DATE, -- The date of publication of the material
	catalog_id INT, -- A reference to the catalog entry for the material.
	genre_id INT -- A reference to the genre of the material.
);

-- Represents a record of library materials with informa<on on their availability and location.
CREATE TABLE IF NOT EXISTS Catalog (
    catalog_id SERIAL PRIMARY KEY, 
    name VARCHAR(500), -- The name of the catalog.
...
CREATE TABLE IF NOT EXISTS Author (
    ...
    birth_date DATE,
    nationality VARCHAR(100) -- The nationality of the author (optional).
);
